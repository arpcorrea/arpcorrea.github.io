...
```
That is it! It is important to mention that every time you run the code, a different RVE is generated. Play around with the parameters in order to have the most suitable RVE for your task. You can <a href="mailto:andre.rittner-pires-correa.1@ens.etsmtl.ca?subject=[Blog]">send</a> me a message if you have any pending doubt.
