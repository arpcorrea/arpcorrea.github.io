...
{% include figure image_path="/assets/images/heat_transfer_no_exhange.jpg" alt="Index Coverage Report in Google Search Console" caption="Index Coverage Report in Google Search Console"%}
